    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="w-full max-w-md mx-auto p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg bg-white dark:bg-background-dark border border-border-light dark:border-border-dark hover:bg-background-light/50 dark:hover:bg-background-light/10 transition-colors"
              >
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-4 text-sm text-subtle-light dark:text-subtle-dark">OR</span>
              <div className="flex-grow border-t border-border-light dark:border-border-dark"></div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="form-input w-full px-4 py-3 rounded-lg bg-white dark:bg-background-dark border border-border-light dark:border-border-dark focus:ring-2 focus:ring-primary focus:border-primary text-text-light dark:text-text-dark"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-lg bg-primary text-white font-semibold hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-background-dark transition-all disabled:opacity-50"
            >
          ...
          {/* Terms and Privacy */}
          {!isLogin && (
            <p className="text-xs text-subtle-light dark:text-subtle-dark text-center mt-6">
          ...
          {/* Toggle Login/Signup */}
          <p className="text-sm text-subtle-light dark:text-subtle-dark text-center mt-4">
