    ...
    <div className="flex min-h-screen w-full flex-col bg-gray-50 text-slate-800 dark:bg-slate-900 dark:text-slate-200">
      ...
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          ...
          <a className="text-sm font-medium text-slate-400 dark:text-slate-500" href="#">Graphics</a>
          <a className="text-sm font-medium text-slate-400 dark:text-slate-500" href="#">Brand Kits</a>
          <a className="text-sm font-medium text-slate-400 dark:text-slate-500" href="#">Calendar</a>
        </nav>
      ...
      {/* Body */}
      <main className="flex-1 bg-gray-50 py-12 dark:bg-slate-900">
