    ...
    <div className="min-h-dvh p-6 text-slate-100 bg-slate-950">
      ...
      <div className="grid md:grid-cols-[1fr_360px] gap-6">
        <div className="rounded-lg border border-slate-800 p-6 bg-slate-900/40">
          <div
            className={`h-72 rounded border-2 ${dragOver ? 'border-emerald-500' : 'border-dashed border-slate-700'} flex items-center justify-center bg-slate-950/50`}
          ...
          >
            {imageUrl ? (
              ...
              <div className="text-center text-slate-400">
                ...
                <div className="text-xs">or paste an URL below</div>
              </div>
            )}
          </div>
        </div>
